...
const Body = () => {
  ...
  return restaurantList.length === 0 ? (
    ...
    <div className="body max-w-[1250px] mx-auto">
      <div className="filter flex">
        <div className="search m-4 p-4">
          <input
            type="text"
            className="searchBox border border-solid border-black rounded-md p-1 "
            value={searchText}
            onChange={(event) => {
          ...
          <button
            className="px-3 py-2 bg-Medium-Brown m-3 rounded-lg text-white hover:bg-Dark-Brown"
            onClick={() => {
        ...
        <div className=" m-4 p-4 flex items-center">
          ...
          <button
            className="bg-Medium-Brown text-white px-4 py-2 rounded-lg shadow-md hover:bg-Dark-Brown hover:shadow-lg transition duration-300 ease-in-out"
            onClick={() => {
              // console.log("Button was clicked");
        ...
        <div className="m-4 p-4 flex items-center">
          <label className="p-2 font-medium ">User Name: </label>
          <input
            className="border border-black p-1 m-3 rounded-lg text-black bg-Light-Brown"
            value={loggedInUser}
            onChange={(e) => setUserName(e.target.value)}
          />
        </div>
